          ...
          <div class="contentidoDerecha">           		
              ...
              <div class="recuadroBlanco">
              		 <form action="indexDos.php" method="post" onsubmit="return validacion()" >
                     	...
                     	<div class="recuadroBlanco">
                                <b>Identificación</b> </p> <input type="text" name="identificacion" id="identificacion" placeholder="Identificación"  placeholder="Identificación" pattern="[0-9]{5,15}" required/>
                        </div>                        
                     	<div class="recuadroBlanco">
                                <b>Teléfono</b> </p> </p> <input type="text" name="telefono" id="telefono" placeholder="Teléfono" placeholder="Su Número" 
