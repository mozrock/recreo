  ...
  <div class="contentido">
  	<!-- InstanceBeginEditable name="EditRegion3" -->
          ...
          <div class="contentidoIzquierda" align="right">
            <div class="recuadroBlanco" align="right">    	
          		<img src="../imagenes/linea_transparente.png" width="15%" />	
            </div>       
            <br/>
            <div class="recuadroAzulDos" align="right">    	
          		<img src="../imagenes/texto_1_juego.png" width="60%" />
            </div>     
            <div class="recuadroBlanco" align="right">    	
          		<img src="../imagenes/linea_transparente.png" width="15%" />	
            </div>            <div class="recuadroBlanco" align="right">    	
          		<img src="../imagenes/texto_2_juego.png" width="60%" />
            </div>    
            <div class="recuadroBlanco" align="right">    	
          		<img src="../imagenes/boton_jugar.png" width="18%" />	
            </div>    
          </div>  
