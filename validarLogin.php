       				...
       				<div id="centrado"   >
							...
							<!-- InstanceBeginEditable name="EditRegion5" -->
									...
									<?php          
										...
										//$query_Recordset1 = "SELECT * from USUARIOS where NOMBRE_USUARIO='readmin'";
										...
										if($row = mysqli_fetch_array($Recordset1)){
											...
											if($sha1_second_value == $row['PASSWORD']){
												...
												echo " Hola mundo 9dd rrrr" ;
												echo"<script language='javascript'>window.location='loginAdministracion.php'</script>;";
												//header("Location: loginAdministracion.html");
												exit();
											}
										}else{
											echo "Hola mundo 9" ;
